...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post counters_url, params: { counter: { totaldown: @counter.totaldown, totalup: @counter.totalup } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { totaldown: @counter.totaldown, totalup: @counter.totalup } }
